...
class ProductoRepository {
     ...
     * @returns {Object}
     */
    jsonToSave(id, timestampp, nombre, descripcion, codigo, foto, precio, stock) {
        try {
    ...
    guardar(id, timestampp, nombre, descripcion, codigo, foto, precio, stock) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                fs_1.default.writeFileSync('./Productos.txt', JSON.stringify(this.jsonToSave(id, timestampp, nombre, descripcion, codigo, foto, precio, stock)));
